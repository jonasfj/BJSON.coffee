...
///////////// MY Hack
  ...
  function ByteOutputStreamCounter() {
    /** @type {number} */
    var pos = 0;
  ...
  TextEncoder.prototype = {
    ...
    **********************************/
    encode: function encode(opt_string, options) {
      ...
      var output_stream = new ByteOutputStreamCounter();
      var input_stream = new CodePointInputStream(opt_string);
      while (input_stream.get() !== EOF_code_point) {
        this._encoder.encode(output_stream, input_stream);
      }
      ...
      var bytes = new Uint8Array(output_stream.size());
      output_stream = new ByteOutputStream(bytes);
      input_stream = new CodePointInputStream(opt_string);
      while (input_stream.get() !== EOF_code_point) {
        this._encoder.encode(output_stream, input_stream);
      }
      if (!this._streaming) {
