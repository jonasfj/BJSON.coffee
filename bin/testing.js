...
(function() {
  var allTests, appendScript, compare, fetchResults;
  ...
  this._fetchedResults = function(_arg) {
    var bad, browser, category_name, count, data, inconsistent, results, succ, summary_score, supported, table, test, tests, tr, unknown, v, _i, _len, _ref, _ref1, _ref2;
